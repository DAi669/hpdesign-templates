(()=>{
  ...
  if('IntersectionObserver' in window && !reduced){
    const ts=document.querySelectorAll('.about-grid > *,.bq,.or-steps li,.order-grid > *,.visit-grid > *,.sec-head');
  ...
  if(!document.querySelector('.l1-fab')){
    ...
    fab.href='#order'; fab.className='l1-fab'; fab.textContent='ご注文・相談';
    fab.style.background='var(--terracotta,#C97D5B)';
